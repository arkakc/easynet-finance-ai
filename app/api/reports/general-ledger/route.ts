...
const pngDate = (value: Date) => new Intl.DateTimeFormat("en-CA", {
...
export async function GET(request: NextRequest) {
  try {
    ...
    const rows = lines.map(l => {
      ...
      return { id:l.id, date:pngDate(l.journal.date), journalId:l.journal.id, journalCode:l.journal.code, documentType:l.journal.sourceDocType, documentNo:l.journal.sourceDocId, reference:l.journal.reference || l.journal.description, description:l.description, debit, credit, balance:running };
    });
