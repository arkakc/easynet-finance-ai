...
const FRESH_START_COA = [
  ...
  ['ACC-1120','1120','Bank Account','Asset','ACC-1100',true],
  ...
  ['ACC-2130','2130','Third-Party Loan Payable','Liability','ACC-2100',true],
  ['ACC-2140','2140','Accrued Interest Payable','Liability','ACC-2100',true],
  ['ACC-2150','2150','Customer Advances','Liability','ACC-2100',true],
  ...
  ['ACC-3100','3100','Share Capital / Owner Capital','Equity','ACC-3000',true],
  ...
  ['ACC-4600','4600','Consulting & Support Revenue','Income','ACC-4000',true],
  ...
  ['ACC-6910','6910','Professional Fees','Expense','ACC-6000',true],
  ['ACC-6920','6920','Insurance','Expense','ACC-6000',true],
  ['ACC-6930','6930','Utilities','Expense','ACC-6000',true],
  ['ACC-6940','6940','Staff Costs','Expense','ACC-6000',true],
